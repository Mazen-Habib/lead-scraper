...
import { normalizeUrl, dedupeKey } from '../src/lib/normalizeUrl.js';
...
test('dedupeKey prefers website, falls back to name', () => {
  assert.equal(dedupeKey({ website: 'https://acme.com/', name: 'Acme Inc' }), 'acme.com');
  assert.equal(dedupeKey({ website: '', name: 'Acme Inc' }), 'acme inc');
});
